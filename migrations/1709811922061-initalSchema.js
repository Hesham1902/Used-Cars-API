...
module.exports = class InitalSchema1709811922061 {
  name = 'InitalSchema1709811922061';

  async up(queryRunner) {
    await queryRunner.query(
      `CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar NOT NULL, "admin" boolean NOT NULL DEFAULT (1), "password" varchar NOT NULL)`,
    );
    await queryRunner.query(
