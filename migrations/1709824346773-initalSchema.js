...
module.exports = class InitalSchema1709824346773 {
    name = 'InitalSchema1709824346773'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar NOT NULL, "admin" boolean NOT NULL DEFAULT (0), "password" varchar NOT NULL)`);
